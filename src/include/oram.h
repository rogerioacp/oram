 ...
 *
 * args:
 * ORAMState state - Input argument that points to the ORAM structure
 * containing the internal details details.
 * BlockNumber blkno - Input argument that specifies the input blocknumber of
 * the non-oblivious file.
 *
 */
 ...
 * BlockNumber blkno - Input argument that specifies the input blocknumber of
 * the non-oblivious file.
 * char* value - Input argument that points to the new block statues to be
 * written to the oblivious file.
 *
 */
void		write(ORAMState state, BlockNumber blkno, char *value);
